  ...
  switch (target) {
    ...
    case "impression-Hidden":
      ...
      */
      ...
      let impression_count = impressionsExpanded.getElementsByTagName("div").length;
      ...
      for (const this_uuid in payload) {
        ...
        if (payload_ast && payload_ast[0]) {
          ...
          let this_impression_found = typeof this_impression === "object" && this_impression;
          console.log(mode, this_impression_found, this_impression); // add this impression to carousel
