...
const lispCallback = (payload, context, hooks = []) => {
  ...
  switch (context) {
    case "paneVisible":
      ...
      parameter_one = parameter_two[1]; // TODO: do something with the icon

      console.log("todo -- add icon to controller:", icon); // ...command will now run below
    ...
    case "paneHidden":
      ...
      console.log("todo -- remove icon to controller:", icon); // ...command will now run below
