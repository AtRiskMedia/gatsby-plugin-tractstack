  ...
  switch (target) {
    ...
    case "impression-Hidden":
      ...
      */
      ...
      let iconsMinimized = document.getElementById("controller-minimized-icons"); //let impressionsExpanded = document.getElementById("controller-carousel");

      let icon_count = iconsMinimized.getElementsByTagName("li").length; //let impression_count =
      ...
      for (const this_uuid in payload) {
        ...
        if (payload_ast && payload_ast[0]) {
          ...
          let this_icon_found = typeof this_icon === "object" && this_icon; //let this_impression = document.getElementById(`${this_uuid}`);
